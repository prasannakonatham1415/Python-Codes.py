...
# program to display quotient and remainder after division
a = 7
b = 9
if a > 0 and b > 0:
    print("Quotient =", a // b)
...
# program to find the total and average of 3 numbers
n1 = 5
n2 = 7
n3 = 8
total = n1 + n2 + n3
...
# program to find the cube of given number
a = 6
if a > 0:
   print("Cube=",a**3)	

# program to find the sum of square and cube of given number
a = 5
if a > 0:
    print((a ** 2) + (a ** 3))
